...
def forcing_function(time, point):
    ...
    Turbine_Center_x = 0.3 * DOMAIN_SIZE
    Turbine_Center_y = 0.5 * DOMAIN_SIZE
    Turbine_D = 0.15 * DOMAIN_SIZE
    y_s = Turbine_Center_y - 0.5 * Turbine_D
    y_e = Turbine_Center_y + 0.5 * Turbine_D
    x_s = Turbine_Center_x - DOMAIN_SIZE/(N_POINTS-1)
    x_e = Turbine_Center_x + DOMAIN_SIZE/(N_POINTS-1)
